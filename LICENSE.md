...
Required Notice: Consequence Warehouse Safety Proof Kit is source-available for personal and non-commercial use. Commercial use, including incorporation into paid products, hosted services, managed services, enterprise products, robot fleet products, logistics products, safety products, or commercial AI coding/agent/model products, requires a separate written license from the licensor.
Required Notice: This public proof kit does not publish or license the private Consequence Warehouse Safety engine.
